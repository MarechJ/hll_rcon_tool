...
def upgrade():
    ...
    op.create_index(op.f('ix_audit_log_command'), 'audit_log', ['command'], unique=False)
    op.add_column('player_stats', sa.Column('death_by_weapons', postgresql.JSONB(astext_type=sa.Text()), nullable=True))
