...
def upgrade():
    ...
    op.create_table('player_watchlist',
    ...
    op.create_index(op.f('ix_player_watchlist_playersteamid_id'), 'player_watchlist', ['playersteamid_id'], unique=True)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_player_watchlist_playersteamid_id'), table_name='player_watchlist')
