...
def upgrade():
    ...
    sa.UniqueConstraint('server_number', 'datapoint_time', name='unique_server_count')
    )
    op.create_index(op.f('ix_server_counts_map_id'), 'server_counts', ['map_id'], unique=False)
    op.create_table('player_at_count',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['servercount_id'], ['server_counts.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_player_at_count_playersteamid_id'), 'player_at_count', ['playersteamid_id'], unique=False)
    op.create_index(op.f('ix_player_at_count_servercount_id'), 'player_at_count', ['servercount_id'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_player_at_count_servercount_id'), table_name='player_at_count')
    op.drop_index(op.f('ix_player_at_count_playersteamid_id'), table_name='player_at_count')
