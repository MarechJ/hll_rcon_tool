...
def test_ban_excluded_weapon(*args):
    tk_log = {
        ...
        "action": "TEAM KILL",
        "player_name_1": "[ARC] DYDSO",
        "player_id_1": 76561198091327692,
        "player_name_2": "Francky Mc Fly",
        "player_id_2": 76561198091327692,
        "weapon": "None",
        "raw": "[646 ms (1612695641)] TEAM KILL: [ARC] DYDSO(Axis/76561198091327692) -> Francky Mc Fly(Axis/76561198133214514) with None",
        "content": "[ARC] DYDSO(Axis/76561198091327692) -> Francky Mc Fly(Axis/76561198133214514) with None",
    }
    logs = [
        tk_log,
        {
            ...
            "player_id_1": None,
            "player_id_2": None,
            "raw": "[600 ms (1612695428)] CONNECTED [ARC] DYDSO",
            "content": "[ARC] DYDSO",
            "server": "1",
        },
    ]
