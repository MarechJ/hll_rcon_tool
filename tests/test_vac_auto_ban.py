...
def test_should_not_ban():
    ...
    assert not should_ban({"SteamId": "...", "CommunityBanned": True, "VACBanned": False, "NumberOfVACBans": 0,
                           "DaysSinceLastBan": 1, "NumberOfGameBans": 5, "EconomyBan": "none"}, 6, 40)
...
def test_should_ban():
    ...
    assert should_ban({"SteamId": "...", "CommunityBanned": True, "VACBanned": True, "NumberOfVACBans": 0,
                           "DaysSinceLastBan": 1, "NumberOfGameBans": 5, "EconomyBan": "none"}, 5, 4)

    assert should_ban({"SteamId": "...", "CommunityBanned": True, "VACBanned": False, "NumberOfVACBans": 0,
                           "DaysSinceLastBan": 1, "NumberOfGameBans": 5, "EconomyBan": "none"}, 5, 4)

    assert should_ban({"SteamId": "...", "CommunityBanned": True, "VACBanned": True, "NumberOfVACBans": 0,
                           "DaysSinceLastBan": 1, "NumberOfGameBans": 1, "EconomyBan": "none"}, 1, 4)