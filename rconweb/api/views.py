...
ENDPOINT_PERMISSIONS: dict[Callable, list[str] | set[str] | str] = {
    ...
    rcon_api.get_scoreboard_config: "api.can_view_scoreboard_config",
    ...
    rcon_api.set_scoreboard_config: "api.can_change_scoreboard_config",
    ...
    rcon_api.validate_scoreboard_config: "api.can_change_scoreboard_config",
    ...
    rcon_api.get_default_vip_list: "api.can_view_vip_lists",
    ...
    rcon_api.get_vip_sync_plan: "api.can_view_vip_ids",
    rcon_api.get_vip_sync_status: "api.can_view_vip_ids",
    ...
    rcon_api.edit_vip_list_records: "api.can_change_vip_list_records",
    rcon_api.delete_vip_list_record: "api.can_delete_vip_list_records",
    rcon_api.delete_vip_list_records: "api.can_delete_vip_list_records",
...
RCON_ENDPOINT_HTTP_METHODS: dict[Callable, list[str]] = {
    ...
    rcon_api.get_default_vip_list: ["GET"],
    ...
    rcon_api.get_vip_sync_plan: ["GET"],
    rcon_api.get_vip_sync_status: ["GET"],
    ...
    rcon_api.edit_vip_list_records: ["POST"],
    rcon_api.delete_vip_list_record: ["POST"],
    rcon_api.delete_vip_list_records: ["POST"],
