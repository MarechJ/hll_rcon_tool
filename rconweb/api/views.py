...
ENDPOINT_PERMISSIONS: dict[Callable, list[str] | set[str] | str] = {
    ...
    rcon_api.get_auto_mod_team_balance_config: "api.can_view_auto_mod_team_balance_config",
    ...
    rcon_api.set_auto_mod_team_balance_config: "api.can_change_auto_mod_team_balance_config",
    ...
    rcon_api.validate_auto_mod_team_balance_config: "api.can_change_auto_mod_team_balance_config",
...
RCON_ENDPOINT_HTTP_METHODS: dict[Callable, list[str]] = {
    ...
    rcon_api.get_auto_mod_team_balance_config: ["GET"],
    ...
    rcon_api.set_auto_mod_team_balance_config: ["POST"],
    ...
    rcon_api.validate_auto_mod_team_balance_config: ["POST"],
