# Generated for the Team Balance automod (adds can_view/can_change_auto_mod_team_balance_config)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("api", "0023_alter_rconuser_options"),
    ]
        ...
        migrations.AlterModelOptions(
            ...
            options={
                ...
                "permissions": (
                    ...
                    (
                        "can_view_auto_mod_team_balance_config",
                        "Can view Auto Mod Team Balance config",
                    ),
                    (
                        "can_change_auto_mod_team_balance_config",
                        "Can change Auto Mod Team Balance config",
                    ),
                    (
