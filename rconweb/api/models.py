...
class RconUser(User):
    ...
    class Meta:
        ...
        permissions = (
            ...
            ("can_view_rcon_chat_commands_config", "Can view the rcon chat commands config"),
            ("can_change_rcon_chat_commands_config", "Can change rcon the chat commands config"),
