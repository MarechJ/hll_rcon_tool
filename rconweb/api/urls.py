...
endpoints: list[tuple[str, Callable]] = [
    ...
    (
        ...
        user_settings.get_auto_broadcasts_config
    ),
    (
        "describe_auto_broadcasts_config",
        user_settings.describe_auto_broadcasts_config
    ),
    (
        "validate_auto_broadcasts_config",
        user_settings.validate_auto_broadcasts_config
    ),
    (
        "set_auto_broadcasts_config",
        user_settings.set_auto_broadcasts_config
    ),
    (
        "get_votekick_autotoggle_config",
        user_settings.get_votekick_autotoggle_config
    ),
    (
    ...
    (
        ...
        user_settings.set_votekick_autotoggle_config
    ),
    (
        "get_auto_mod_level_config",
        user_settings.get_auto_mod_level_config
    ),
    (
        "describe_auto_mod_level_config",
        user_settings.describe_auto_mod_level_config
    ),
    (
        "validate_auto_mod_level_config",
        user_settings.validate_auto_mod_level_config
    ),
    (
        "set_auto_mod_level_config",
        user_settings.set_auto_mod_level_config
    ),
    (
        "get_auto_mod_no_leader_config",
        user_settings.get_auto_mod_no_leader_config
    ),
    (
    ...
    (
        ...
        user_settings.set_auto_mod_no_leader_config
    ),
    (
        "get_auto_mod_seeding_config",
        user_settings.get_auto_mod_seeding_config
    ),
    (
    ...
    (
        ...
        user_settings.set_auto_mod_seeding_config
    ),
    (
        "get_auto_mod_solo_tank_config",
        user_settings.get_auto_mod_solo_tank_config
    ),
    (
    ...
    (
        ...
        user_settings.set_auto_mod_solo_tank_config
    ),
    (
        "get_tk_ban_on_connect_config",
        user_settings.get_tk_ban_on_connect_config
    ),
    (
    ...
    (
        ...
        user_settings.set_tk_ban_on_connect_config
    ),
    (
        "get_camera_notification_config",
        user_settings.get_camera_notification_config
    ),
    (
    ...
    (
        ...
        user_settings.set_camera_notification_config
    ),
    (
        "get_expired_vip_config",
        user_settings.get_expired_vip_config
    ),
    (
        "describe_expired_vip_config",
        user_settings.describe_expired_vip_config
    ),
    (
        "validate_expired_vip_config",
        user_settings.validate_expired_vip_config
    ),
    (
        "set_expired_vip_config",
        user_settings.set_expired_vip_config
    ),
    (
        "get_server_name_change_config",
        user_settings.get_server_name_change_config
    ),
    (
    ...
    (
        ...
        user_settings.set_server_name_change_config
    ),
    (
        "get_log_line_webhook_config",
        user_settings.get_log_line_webhook_config
    ),
    (
    ...
    (
        ...
        user_settings.set_log_line_webhook_config
    ),
    (
        "get_message_on_connect_config",
        user_settings.get_message_on_connect_config
    ),
    (
    ...
    (
        "validate_message_on_connect_config",
        user_settings.validate_message_on_connect_config,
    ),
    (
        "set_message_on_connect_config",
        user_settings.set_message_on_connect_config
    ),
    (
        "get_name_kick_config",
        user_settings.get_name_kick_config
    ),
    (
        "describe_name_kick_config",
        user_settings.describe_name_kick_config
    ),
    (
        "validate_name_kick_config",
        user_settings.validate_name_kick_config
    ),
    (
        "set_name_kick_config",
        user_settings.set_name_kick_config
    ),
    (
    ...
    (
        ...
        user_settings.get_rcon_server_settings_config
    ),
    (
    ...
    (
        ...
        user_settings.set_rcon_server_settings_config
    ),
    (
        "get_scorebot_config",
        user_settings.get_scorebot_config
    ),
    (
        "describe_scorebot_config",
        user_settings.describe_scorebot_config
    ),
    (
        "validate_scorebot_config",
        user_settings.validate_scorebot_config
    ),
    (
        "set_scorebot_config",
        user_settings.set_scorebot_config
    ),
    (
        "get_standard_broadcast_messages",
        user_settings.get_standard_broadcast_messages
    ),
    (
    ...
    (
        ...
        user_settings.set_standard_broadcast_messages
    ),
    (
    ...
    (
        ...
        user_settings.get_standard_welcome_messages
    ),
    (
    ...
    (
        ...
        user_settings.set_standard_welcome_messages
    ),
    (
        "get_steam_config",
        user_settings.get_steam_config
    ),
    (
        "describe_steam_config",
        user_settings.describe_steam_config
    ),
    (
        "validate_steam_config",
        user_settings.validate_steam_config
    ),
    (
        "set_steam_config",
        user_settings.set_steam_config
    ),
    (
        "get_vac_game_bans_config",
        user_settings.get_vac_game_bans_config
    ),
    (
        "describe_vac_game_bans_config",
        user_settings.describe_vac_game_bans_config
    ),
    (
        "validate_vac_game_bans_config",
        user_settings.validate_vac_game_bans_config
    ),
    (
        "set_vac_game_bans_config",
        user_settings.set_vac_game_bans_config
    ),
    (
    ...
    (
        ...
        user_settings.get_all_discord_webhooks_config
    ),
    (
        "get_all_standard_message_config",
        user_settings.get_all_standard_message_config
    ),
