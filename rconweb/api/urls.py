...
endpoints: list[tuple[str, Callable]] = [
    ...
    ("set_camera_config", user_settings.set_camera_config),
    ("validate_camera_config", user_settings.validate_camera_config),
    ("get_camera_config", user_settings.get_camera_config),
