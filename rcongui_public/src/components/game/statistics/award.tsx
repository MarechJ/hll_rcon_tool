...
export const statsMap = {
  ...
  'kills_by_type.sniper': { icon: <CrosshairIcon/> },
  'kills_by_type.artillery': { icon: <CloudHailIcon/> },
  'kills_by_type.armor': { icon: <Settings/> },
  'kills_by_type.machine_gun': { icon: <Grape/> },
