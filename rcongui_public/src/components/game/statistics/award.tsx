...
export const statsMap = {
  ...
  'deaths_by_type.machine_gun': { icon: <MagnetIcon/> },
  'deaths_by_type.sniper': { icon: <TargetIcon/> },
  'deaths_by_type.artillery': { icon: <UmbrellaIcon/> },
  'deaths_by_type.commander': { icon: <PlaneIcon/> },
  'deaths_by_type.mine': { icon: <SearchIcon/> },
  'deaths_by_type.armor': { icon: <BoneIcon/> },
