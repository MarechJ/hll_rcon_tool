...
export const generatePlayerActions = (
  ...
  const gameActions = [messageAction, switchAction, switchOnDeathAction, punishAction, kickAction]

  const actions = onlineAction ? [...gameActions, ...profileActions] : profileActions
