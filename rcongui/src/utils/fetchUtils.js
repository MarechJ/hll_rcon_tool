...
export const cmd = {
  ...
  CREATE_VIP_LIST: (params) => requestFactory({ method: "POST", cmd: "create_vip_list", ...params }),
  EDIT_VIP_LIST: (params) => requestFactory({ method: "POST", cmd: "edit_vip_list", ...params }),
  DELETE_VIP_LIST: (params) => requestFactory({ method: "POST", cmd: "delete_vip_list", ...params }),
  GET_VIP_LIST_RECORD: (params) => requestFactory({ method: "GET", cmd: "get_vip_list_record", ...params }),
  ADD_VIP_LIST_RECORD: (params) => requestFactory({ method: "POST", cmd: "add_vip_list_record", ...params }),
  EDIT_VIP_LIST_RECORD: (params) => requestFactory({ method: "POST", cmd: "edit_vip_list_record", ...params }),
  ADD_OR_EDIT_VIP_LIST_RECORD: (params) => requestFactory({ method: "POST", cmd: "add_or_edit_vip_list_record", ...params }),
  BULK_ADD_VIP_LIST_RECORDS: (params) => requestFactory({ method: "POST", cmd: "bulk_add_vip_list_records", ...params }),
  BULK_DELETE_VIP_LIST_RECORDS: (params) => requestFactory({ method: "POST", cmd: "bulk_delete_vip_list_records", ...params }),
  BULK_EDIT_VIP_LIST_RECORDS: (params) => requestFactory({ method: "POST", cmd: "bulk_edit_vip_list_records", ...params }),
  DELETE_VIP_LIST_RECORD: (params) => requestFactory({ method: "POST", cmd: "delete_vip_list_record", ...params }),
  GET_VIP_STATUS_FOR_PLAYERS: (params) => requestFactory({ method: "GET", cmd: "get_vip_status_for_player_ids", ...params }),
  GET_ACTIVE_VIP_RECORDS: (params) => requestFactory({ method: "GET", cmd: "get_active_vip_records", ...params }),
  GET_INACTIVE_VIP_RECORDS: (params) => requestFactory({ method: "GET", cmd: "get_inactive_vip_records", ...params }),
  GET_PLAYER_VIP_RECORDS: (params) => requestFactory({ method: "GET", cmd: "get_player_vip_records", ...params }),
  GET_PLAYER_VIP_LIST_RECORD: (params) => requestFactory({ method: "GET", cmd: "get_player_vip_list_record", ...params }),
  GET_VIP_LIST_RECORDS: (params) => requestFactory({ method: "GET", cmd: "get_vip_list_records", ...params }),
  GET_ALL_VIP_RECORDS_FOR_SERVER: (params) => requestFactory({ method: "GET", cmd: "get_all_vip_records_for_server", ...params }),
  INACTIVATE_EXPIRED_VIP_RECORDS: (params) => requestFactory({ method: "POST", cmd: "inactivate_expired_vip_records", ...params }),
  EXTEND_VIP_DURATION: (params) => requestFactory({ method: "POST", cmd: "extend_vip_duration", ...params }),
  REVOKE_ALL_VIP: (params) => requestFactory({ method: "POST", cmd: "revoke_all_vip", ...params }),
  SYNCHRONIZE_WITH_GAME_SERVER: (params) => requestFactory({ method: "POST", cmd: "synchronize_with_game_server", ...params }),
  CONVERT_OLD_STYLE_VIP_RECORDS: (params) => requestFactory({ method: "POST", cmd: "convert_old_style_vip_records", ...params }),
};
