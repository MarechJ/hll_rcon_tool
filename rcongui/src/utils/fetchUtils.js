...
export const cmd = {
  ...
  GET_SERVER_STATUS_ANALYTICS: (params) => requestFactory({ method: "GET", cmd: "get_server_status_analytics", ...params }),
  GET_SYSTEM_USAGE: (params) => requestFactory({ method: "GET", cmd: "get_system_usage", ...params }),
  GET_SYSTEM_USAGE_ANALYTICS: (params) => requestFactory({ method: "GET", cmd: "get_system_usage_analytics", ...params }),
