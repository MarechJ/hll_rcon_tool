...
const SHARED_Commands = {
  ...
  GET_BLACKLIST_RECORDS: (params) => requestFactory({ method: "GET", cmd: "get_blacklist_records", ...params }),
  ...
  GET_VIP_SYNC_PLAN: (params) => requestFactory({ method: "GET", cmd: "get_vip_sync_plan", ...params }),
  GET_VIP_SYNC_STATUS: (params) => requestFactory({ method: "GET", cmd: "get_vip_sync_status", ...params }),
  ...
  SET_DEFAULT_VIP_LIST: (params) => requestFactory({ method: "POST", cmd: "set_default_vip_list", ...params }),
  CLEAR_DEFAULT_VIP_LIST: (params) => requestFactory({ method: "POST", cmd: "clear_default_vip_list", ...params }),
  ...
  EDIT_VIP_LIST_RECORDS: (params) => requestFactory({ method: "POST", cmd: "edit_vip_list_records", ...params }),
  DELETE_VIP_LIST_RECORDS: (params) => requestFactory({ method: "POST", cmd: "delete_vip_list_records", ...params }),
  ...
  GET_VOTEMAP_RESULTS: (params) => requestFactory({ method: "GET", cmd: "get_votemap_results", ...params }),
  ...
  ADD_BLACKLIST_RECORD: (params) => requestFactory({ method: "POST", cmd: "add_blacklist_record", ...params }),
  CREATE_BLACKLIST: (params) => requestFactory({ method: "POST", cmd: "create_blacklist", ...params }),
  DELETE_BLACKLIST: (params) => requestFactory({ method: "POST", cmd: "delete_blacklist", ...params }),
  DELETE_BLACKLIST_RECORD: (params) => requestFactory({ method: "POST", cmd: "delete_blacklist_record", ...params }),
  EDIT_BLACKLIST: (params) => requestFactory({ method: "POST", cmd: "edit_blacklist", ...params }),
  EDIT_BLACKLIST_RECORD: (params) => requestFactory({ method: "POST", cmd: "edit_blacklist_record", ...params }),
  ...
  REMOVE_MAP_FROM_VOTEMAP: (params) => requestFactory({ method: "POST", cmd: "remove_map_from_votemap", ...params }),
  ...
  SET_VOTEMAP_WINNER: (params) => requestFactory({ method: "POST", cmd: "set_votemap_winner", ...params }),
