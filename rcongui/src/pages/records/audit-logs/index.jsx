    ...
    <Grid container spacing={2} justifyContent='flex-start' alignItems='center'>
      <Grid size={3}>
        <Autocomplete
          ...
          renderInput={(params) => <TextField {...params} variant='outlined' label='Search for usernames' fullWidth />}
        />
      </Grid>
      <Grid size={3}>
        <Autocomplete
          ...
          renderInput={(params) => <TextField {...params} variant='outlined' label='Search for commands' fullWidth />}
        />
      </Grid>
      <Grid>
        <TextField label='Parameters search' value={paramSearch} onChange={(e) => setParamSearch(e.target.value)} />
      </Grid>
      <Grid>
        <FormControl>
