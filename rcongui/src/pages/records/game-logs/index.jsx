      ...
      <Grid size={12}>
        <form>
          <Grid container spacing={1} justifyContent='space-evenly'>
            <Grid>
              <TextField label='Player ID' value={playerId} onChange={(e) => setPlayerId(e.target.value)} />
            </Grid>
            <Grid>
            ...
            <Grid>
              <TextField label='Server filter' value={server} onChange={(e) => setServer(e.target.value)} />
            </Grid>
            <Grid>
            ...
            <Grid>
              <FormControl>
                ...
                <Select labelId='time_sort_label' value={order} onChange={(e) => setOrder(e.target.value)}>
            ...
            <Grid>
              <Button
                ...
                onSubmit={(e) => {
                  e.preventDefault()
                  onSubmit(name, type, playerId, from, till, limit, order, exactPlayer, exactAction, server)
                }}
                onClick={(e) => {
                  e.preventDefault()
                  onSubmit(name, type, playerId, from, till, limit, order, exactPlayer, exactAction, server)
