...
export const TextButton = styled((props) => <span role='button' tabIndex={0} {...props} />)(({ theme }) => ({
  cursor: 'pointer',
  '&:hover': {
...
export const HeaderButton = styled((props) => <Button size='small' {...props} />)(({ theme }) => ({
  width: '100%',
  minWidth: 16,
  minHeight: 16,
  p: 0,
...
export const SortableHeader =
  (text) =>
  ({ column }) => {
    return <HeaderButton onClick={column.getToggleSortingHandler()}>{text}</HeaderButton>
  }
