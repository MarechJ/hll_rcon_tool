    ...
    <Grid container>
      <Grid size={12}>
        <Typography color='textSecondary' variant='caption' display='block' gutterBottom>
          UI Version: {process.env.REACT_APP_VERSION} API Version: {apiVersion} - Brought to you by Dr.WeeD,{' '}
          {repoData
      ...
      {!process.env.REACT_APP_PUBLIC_BUILD ? (
        <Grid size={12}>
          <Typography color='textSecondary' variant='caption' display='block' gutterBottom>
            ...
            for announcements, questions, feedback and support. Dev or docs contributions are most welcomed.
          </Typography>
        </Grid>
      ) : (
        ''
