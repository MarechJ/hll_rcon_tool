...
function RectangleRight({
  ...
  return (
    <div
      className={cn(
        'grid items-center justify-center text-center basis-1/5 w-1/5 border-t-4 [clip-path:polygon(0%_0%,95%_0%,100%_50%,95%_100%,0%_100%,5%_50%)]',
        team === 'axis' && 'bg-red-300 border-red-500',
        team === 'allies' && 'bg-blue-300 border-blue-500',
        highlighted && 'opacity-100 border-t-0',
        highlighted && team === 'axis' && 'bg-red-500',
...
function RectangleLeft({
  ...
  return (
    <div
      className={cn(
        'grid items-center justify-center text-center basis-1/5 w-1/5 border-t-4 [clip-path:polygon(5%_0%,100%_0,95%_50%,100%_100%,5%_100%,0%_50%)]',
        team === 'axis' && 'bg-red-300 border-red-500',
        team === 'allies' && 'bg-blue-300 border-blue-500',
        highlighted && 'opacity-100 border-t-0',
        highlighted && team === 'axis' && 'bg-red-500',
